...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 25 22:39:09 2025
...
class PIA(nn.Module):
    ...
    def loss_function(self, pred_signal, true_signal, D_pred=None, D_star_pred=None, F_pred=None, D_true=None, D_star_true=None, F_true=None, weights=None):
        loss = F.mse_loss(pred_signal, true_signal)
        if D_pred is not None and D_true is not None:
            loss += F.mse_loss(D_pred, D_true)
            loss += F.mse_loss(D_star_pred, D_star_true)
